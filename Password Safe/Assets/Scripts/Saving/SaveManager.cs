...
public class SaveManager : MonoBehaviour
{
    ...
    public void DataToSave()
    {
        ...
        saveData.folderSaves = StructureManager.instance.folderSaves;
    ...
    {
        StructureManager.instance.folderSaves = saveData.folderSaves;

        for (int i = 0; i < saveData.folderSaves.Count; i++)
        {
            dataCreationManager.CreateFolderFromSave(saveData.folderSaves[i]);
        }
